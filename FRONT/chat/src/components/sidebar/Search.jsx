        ...
        <div>
            <form className="flex flex-col items-center px-2">
                ...
                <label className="flex items-center gap-2">
                    ...
                    <input type="text" placeholder="Look a friend" className="w-full bg-gray-200 rounded-md outline-none p-1 text-black focus:ring-2 focus:ring-rose-500" required />
                    <button >
